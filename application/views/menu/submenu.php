                        ...
                        <tbody>
                            ...
                            <?php foreach ($subMenu as $sm) : ?>
                                <tr>
                                    ...
                                    <td><?= $sm['isactive']; ?></td>
                                    <td>
                                        <a href="<?= base_url('menu/editsubmenu/') . $sm['usersubmenuid']; ?>" class="badge badge-success">edit</a>
                                        <a href="<?= base_url('menu/deletesubmenu/') . $sm['usersubmenuid']; ?>" class="badge badge-danger">hapus</a>
                                    </td>
                                </tr>
                                <?php $i++; ?>
                            <?php endforeach; ?>
                            ...
                            <div class="form-group">
                                <select name="usermenuid" id="usermenuid" class="form-control">
                                    ...
                                    <?php foreach ($menu as $m) : ?>
                                        <option value="<?= $m['usermenuid']; ?>"><?= $m['menu']; ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            <div class="form-group">
